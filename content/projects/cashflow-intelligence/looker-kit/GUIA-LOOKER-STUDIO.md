# Guia de implementação — Google Sheets + Apps Script + Looker Studio

## Arquitetura
1. `Base_Bruta`: recebe importação sem edição manual.
2. Apps Script valida, padroniza e remove duplicidades.
3. `Fato_Movimentacoes`: base tratada para o Looker Studio.
...
6. Looker Studio consome apenas tabelas tratadas.
...
6. No Looker Studio, conecte `Fato_Movimentacoes`.
